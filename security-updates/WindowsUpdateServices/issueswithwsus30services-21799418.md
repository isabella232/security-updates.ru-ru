...
ms:contentKeyID: 21799418
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Dd939824(v=WS.10)'
---
...
-   **MSSQLSERVER** (if you are using Внутренняя база данных Windows, or if you are using SQL Server and are using the default instance name for the instance name).
