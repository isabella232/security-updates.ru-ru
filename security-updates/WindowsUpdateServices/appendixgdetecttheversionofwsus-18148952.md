...
ms:contentKeyID: 18148952
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc720492(v=WS.10)'
---
...
---------------------
        ...
        ```
| ![](/security-updates/images/Cc720492.note(WS.10).gif)Примечание                             |
|---------------------------------------------------------------------------------------------------------|
