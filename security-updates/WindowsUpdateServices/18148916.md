...
ms:contentKeyID: 18148916
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc720452(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720452.note(WS.10).gif)Примечание                                                                                |
|------------------------------------------------------------------------------------------------------------------------------------------------------------|
