...
ms:contentKeyID: 18148936
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc720471(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720471.Important(WS.10).gif)Важно!                                      |
|-------------------------------------------------------------------------------------------------------------------|
