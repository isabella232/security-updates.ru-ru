...
ms:contentKeyID: 18148915
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc720468(v=WS.10)'
---
...
1.  Determine an overall update management plan based on your network topology and bandwidth, company needs, and organizational structure. Considerations might include the following:
    ...
    -   Which database to use for update metadata (for example, Внутренняя база данных Windows®, SQL Server 2005).
