...
ms:contentKeyID: 18149099
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc708465(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708465.note(WS.10).gif)Примечание |
|-----------------------------------------------------------------------------|
