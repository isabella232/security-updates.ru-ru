...
ms:contentKeyID: 18148921
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc720476(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720476.note(WS.10).gif)Примечание                                                                                                                                                    |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
