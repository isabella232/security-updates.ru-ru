...
ms:contentKeyID: 18149169
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc708476(v=WS.10)'
---
...
<td style="border:1px solid black;">Uninstall the product. Also uninstalls the Внутренняя база данных Windows instance if it is installed.</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Path to Внутренняя база данных Windows data directory.</td>
</tr>
<tr class="even">
