...
ms:contentKeyID: 18149164
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc708464(v=WS.10)'
---
...
-   The Внутренняя база данных Windows® database that WSUS can install during setup on Windows Server 2003.
