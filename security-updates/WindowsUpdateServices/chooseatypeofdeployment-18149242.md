...
ms:contentKeyID: 18149242
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc708565(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708565.note(WS.10).gif)Примечание                                                                                    |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
