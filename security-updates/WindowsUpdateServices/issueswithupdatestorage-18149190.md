...
ms:contentKeyID: 18149190
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc708524(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708524.note(WS.10).gif)Примечание          |
|--------------------------------------------------------------------------------------|
