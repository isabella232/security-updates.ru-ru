...
ms:contentKeyID: 18148950
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc720493(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720493.Important(WS.10).gif)Важно!                                      |
|-------------------------------------------------------------------------------------------------------------------|
