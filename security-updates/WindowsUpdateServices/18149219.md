...
ms:contentKeyID: 18149219
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc708547(v=WS.10)'
---
...
-   WSUSWyukonSetup\_*timestamp*.log: This is the log file for Внутренняя база данных Windows setup. All Внутренняя база данных Windows installation/uninstallation information is logged to this file.
