...
ms:contentKeyID: 18149265
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc708592(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708592.note(WS.10).gif)Примечание                                                                                                                                                                                                                                                                                                                |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
If you are using Внутренняя база данных Windows as the WSUS database, use the following string in place of *SqlServerName* in the above command:
