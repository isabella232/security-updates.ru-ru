...
ms:contentKeyID: 18148900
ms:mtpsurl: 'https://technet.microsoft.com/ru-ru/library/Cc720428(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720428.note(WS.10).gif)Примечание                                                                                                                             |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
