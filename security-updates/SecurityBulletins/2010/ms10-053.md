---
TOCTitle: 'MS10-053'
Title: 'Бюллетень по безопасности (Майкрософт) MS10-053 - Критическое'
ms:assetid: 'ms10-053'
ms:contentKeyID: 61236723
ms:mtpsurl: 'https://technet.microsoft.com/ru-RU/library/ms10-053(v=Security.10)'
---

Security Bulletin

Бюллетень по безопасности (Майкрософт) MS10-053 - Критическое
=============================================================

Накопительное обновление для системы безопасности браузера Internet Explorer (2183461)
--------------------------------------------------------------------------------------
...
Это обновление для системы безопасности устраняет 6 обнаруженных пользователями уязвимостей в Internet Explorer. Наиболее серьезные из этих уязвимостей делают возможным удаленное выполнение кода, если пользователь просмотрит особым образом созданную веб-страницу в браузере Internet Explorer. Риск для пользователей, учетные записи которых имеют ограниченные права, меньше, чем для пользователей, работающих с правами администратора.
...
Это обновление безопасности устраняет указанные уязвимости путем изменения способа, используемого браузером Internet Explorer для принудительного выполнения проверок безопасности и обработки объектов в памяти. Дополнительные сведения об этих уязвимостях см. в подразделе ответов на часто задаваемые вопросы для каждой уязвимости, упомянутой в разделе **Сведения об уязвимостях**.
...
В состав этого обновления включено обновление для обеспечения многоуровневой защиты для фильтра XSS Internet Explorer 8.
...
<th style="border:1px solid black;" >
Уязвимость обработчика событий, связанная с междоменными переходами (CVE-2010-1258)
</th>
<th style="border:1px solid black;" >
Уязвимость, приводящая к повреждению неинициализированной области памяти (CVE-2010-2556)
</th>
<th style="border:1px solid black;" >
Уязвимость, приводящая к повреждению неинициализированной области памяти (CVE-2010-2557)
</th>
<th style="border:1px solid black;" >
Уязвимость, приводящая к повреждению памяти из-за состояния гонки (CVE-2010-2558)
</th>
<th style="border:1px solid black;" >
Уязвимость, приводящая к повреждению неинициализированной области памяти (CVE-2010-2559)
</th>
<th style="border:1px solid black;" >
Уязвимость макета HTML, приводящая к повреждению памяти (CVE-2010-2560)
</th>
<th style="border:1px solid black;" >
Совокупный уровень серьезности
</th>
...
<span></span>
В обозревателе Internet Explorer существует уязвимость, позволяющая сценарию получить доступ к окну обозревателя в других домене или зоне обозревателя Internet Explorer, что приводит к раскрытию информации. Злоумышленник может использовать эту уязвимость, создав специальную веб-страницу, которая делает возможным раскрытие информации, если пользователь просмотрит эту веб-страницу и затем выполнит действие мышью в окне браузера.

Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2010-1258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1258).

#### Смягчающие факторы для уязвимости обработчика событий, связанной с междоменными переходами (CVE-2010-1258)
...
#### Временные решения для уязвимости обработчика событий, связанной с междоменными переходами (CVE-2010-1258)
...
-   **Настройте обозреватель Internet Explorer на выдачу запроса перед выполнением активных сценариев или отключите их для зон безопасности "Интернет" и "Местная интрасеть"**
    ...
    **Примечание**. Отключение активных сценариев для зон безопасности "Интернет" и "Местная интрасеть" может привести к неправильной работе некоторых веб-узлов. Если у вас возникли трудности с использованием веб-сайта после изменения уровня безопасности и вы уверены в безопасности данного сайта, его можно добавить в список надежных сайтов. Это обеспечит правильную работу сайта.
...
#### Часто задаваемые вопросы об уязвимости обработчика событий, связанной с междоменными переходами (CVE-2010-1258)
...
Веб-браузер Internet Explorer неправильно интерпретирует происхождение сценария, разрешая его запуск в контексте домена или зоны безопасности Internet Explorer, отличных от места его происхождения.

**Что может сделать злоумышленник, который воспользуется этой уязвимостью?**  
Злоумышленник, успешно воспользовавшийся этой уязвимостью, может выполнить сценарий в контексте учетной записи пользователя, просматривающего веб-страницу, что потенциально делает возможным раскрытие информации злоумышленнику.
...
Это обновление изменяет Internet Explorer таким образом, что при проверке происхождения сценария принудительно выполняются проверки безопасности.
...
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2010-2556](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2556).

#### Смягчающие факторы для уязвимости, приводящей к повреждению неинициализированной области памяти (CVE-2010-2556)
...
#### Временные решения для уязвимости, приводящей к повреждению неинициализированной области памяти (CVE-2010-2556)
...
#### Часто задаваемые вопросы об уязвимости, приводящей к повреждению неинициализированной области памяти (CVE-2010-2556)
...
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2010-2557](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2557).

#### Смягчающие факторы для уязвимости, приводящей к повреждению неинициализированной области памяти (CVE-2010-2557)
...
#### Временные решения для уязвимости, приводящей к повреждению неинициализированной области памяти (CVE-2010-2557)
...
#### Часто задаваемые вопросы об уязвимости, приводящей к повреждению неинициализированной области памяти (CVE-2010-2557)
...
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2010-2558](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2558).

#### Смягчающие факторы для уязвимости, приводящей к повреждению памяти из-за состояния гонки (CVE-2010-2558)

К факторам, снижающим опасность уязвимости, относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие факторы могут снизить опасность использования уязвимости.

-   В случае атаки через Интернет злоумышленник может разместить в сети веб-сайт, содержащий веб-страницу, предназначенную для использования данной уязвимости. Кроме того, веб-сайты, подвергшиеся атаке злоумышленников, равно как и веб-сайты, принимающие или размещающие пользовательские материалы, также могут иметь специальное содержимое, рассчитанное на использование данной уязвимости. Однако в любом случае злоумышленник не может заставить пользователей посетить эти веб-сайты. Он старается склонить их к этому, убеждая, как правило, щелкнуть ссылку, ведущую на веб-узел, в сообщении электронной почты или программы обмена мгновенными сообщениями.

#### Временные решения для уязвимости, приводящей к повреждению памяти из-за состояния гонки (CVE-2010-2558)

Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.

#### Часто задаваемые вопросы об уязвимости, приводящей к повреждению памяти из-за состояния гонки (CVE-2010-2558)
...
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2010-2559](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2559).

#### Смягчающие факторы для уязвимости, приводящей к повреждению неинициализированной области памяти (CVE-2010-2559)
...
#### Временные решения для уязвимости, приводящей к повреждению неинициализированной области памяти (CVE-2010-2559)
...
#### Часто задаваемые вопросы об уязвимости, приводящей к повреждению неинициализированной области памяти (CVE-2010-2559)
...
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2010-2560](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2560).

#### Смягчающие факторы для уязвимости макета HTML, приводящей к повреждению памяти (CVE-2010-2560)
...
#### Временные решения для уязвимости макета HTML, приводящей к повреждению памяти (CVE-2010-2560)
...
#### Часто задаваемые вопросы об уязвимости макета HTML, приводящей к повреждению памяти (CVE-2010-2560)
...
Используйте компонент <strong>Установка и удаление программ</strong> панели управления или служебную программу Spuninst.exe, которая находится в папке %Windir%\$NTUninstallKB2183461$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 для всех поддерживаемых выпусков Windows XP:<br />
Используйте компонент <strong>Установка и удаление программ</strong> панели управления или служебную программу Spuninst.exe, которая находится в папке %Windir%\ie7updates\KB2183461-IE7\spuninst.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 для всех поддерживаемых выпусков Windows XP:<br />
Используйте компонент <strong>Установка и удаление программ</strong> панели управления или служебную программу Spuninst.exe, которая находится в папке %Windir%\ie8updates\KB2183461-IE8\spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Сведения о файлах</strong></td>
<td style="border:1px solid black;">См. <a href="http://support.microsoft.com/kb/2183461">статью 2183461 базы знаний Майкрософт</a></td>
</tr>
<tr class="even">
...
-   Дэвида Блума (David Bloom) из компании [Google Inc.](http://www.google.com/) за сообщение об уязвимости обработчика событий, связанной с междоменными переходами (CVE-2010-1258)  
-   Николя Жоли (Nicolas Joly) из [отдела исследования уязвимостей VUPEN](http://www.vupen.com) за сообщение об уязвимости, приводящей к повреждению неинициализированной области памяти (CVE-2010-2556)  
-   Николя Жоли (Nicolas Joly) из [отдела исследования уязвимостей VUPEN](http://www.vupen.com/) за сообщение об уязвимости, приводящей к повреждению неинициализированной области памяти (CVE-2010-2557)  
-   Николя Жоли (Nicolas Joly) из [отдела исследования уязвимостей VUPEN](http://www.vupen.com/) за сообщение об уязвимости, приводящей к повреждению памяти из-за состояния гонки (CVE-2010-2558)  
-   Пользователя Gambino ZaDarkSide за сообщение об уязвимости, приводящей к повреждению неинициализированной области памяти (CVE-2010-2559)  
-   Николя Жоли (Nicolas Joly) из [отдела исследования уязвимостей VUPEN](http://www.vupen.com/) за сообщение об уязвимости макета HTML, приводящей к повреждению памяти (CVE-2010-2560)
