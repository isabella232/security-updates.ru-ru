---
TOCTitle: 'MS12-025'
Title: 'Бюллетень по безопасности (Майкрософт) MS12-025 - Критическое'
ms:assetid: 'ms12-025'
ms:contentKeyID: 61237565
ms:mtpsurl: 'https://technet.microsoft.com/ru-RU/library/ms12-025(v=Security.10)'
---

Security Bulletin

Бюллетень по безопасности (Майкрософт) MS12-025 - Критическое
=============================================================

Уязвимость платформы .NET Framework делает возможным удаленное выполнение кода (2671605)
----------------------------------------------------------------------------------------

Дата публикации: 10 апреля 2012 г. | Дата обновления: 12 июня 2012 г.
...
Данное обновление для системы безопасности имеет уровень серьезности "критический" для Microsoft .NET Framework 1.0 с пакетом обновления 3 (SP3), Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1), Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2), Microsoft .NET Framework 3.5.1 и Microsoft .NET Framework 4 во всех поддерживаемых выпусках системы Microsoft Windows. Дополнительные сведения см. в подразделе **Подвержены и не подвержены уязвимости** далее в этом разделе.

Данное обновление для системы безопасности устраняет уязвимость, исправляя способ проверки параметров, который используется системой Microsoft .NET Framework при передаче данных в функцию. Дополнительные сведения об этой уязвимости см. в подразделе "Часто задаваемые вопросы" для соответствующей уязвимости в следующем ниже разделе **Сведения об уязвимости**.
...
**\*Уязвимости подвержены системы, при развертывании которых устанавливалось только ядро сервера.** Это обновление относится (с одинаковой степенью серьезности) к указанным поддерживаемым выпускам Windows Server 2008 R2 независимо от того, выбиралась ли для них установка только ядра сервера. Дополнительные сведения об этом варианте установки см. в статьях TechNet, [Управление ядром сервера: установка](http://technet.microsoft.com/en-us/library/ee441255(ws.10).aspx) (на английском языке) и [Обслуживание установки ядра сервера](http://technet.microsoft.com/en-us/library/ff698994(ws.10).aspx) (на английском языке). Обратите внимание, что вариант установки ядра сервера не применим в определенных выпусках Windows Server 2008; подробности см. в статье [Сравнение вариантов установки ядра сервера](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx).
...
<span></span>
**Почему выпущена** **новая редакция** **этого бюллетеня** **от** **12 июня2012 г.?** **
**Повторная публикация бюллетеня обусловлена повторным выпуском обновления для всех программных продуктов, подверженных уязвимости. Повторно предлагаемое обновление устраняет известную проблему с печатью из приложения Windows Forms. В некоторых случаях после установки обновления, первоначально выпущенного 10 апреля 2012 г., приложения Windows Forms могут не печатать или не соблюдать при печати настройки принтера; при этом нет воздействия на системы, в которых не используется функция печати приложения Windows Forms .NET Framework. Пользователи, успешно установившие исходное обновление, должны установить повторно предлагаемое обновление.

**Подвержены ли этой уязвимости Microsoft .NET Framework 3.5 и Microsoft .NET Framework 4.5** **на Windows** **Developer Preview** **и Microsoft .NET Framework 4.5 Developer Preview** **?**
...
|-----------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| Microsoft .NET Framework 3.5 на Windows Developer Preview                                                 | [Статья 2656380 базы знаний Майкрософт](http://support.microsoft.com/kb/2656380) |
| Microsoft .NET Framework 4.5 на Windows Developer Preview                                                 | [Статья 2656371 базы знаний Майкрософт](http://support.microsoft.com/kb/2656371) |
| Microsoft .NET Framework 4.5 Developer Preview на Windows Server 2008, Windows 7 и Windows Server 2008 R2 | [Статья 2656381 базы знаний Майкрософт](http://support.microsoft.com/kb/2656381) |
...
В этом бюллетене описана уязвимость слоев объектов .NET Framework 2.0. В установщике .NET Framework 3.0 с пакетом обновления 2 (SP2) запрограммирована установка .NET Framework 2.0 с пакетом обновления 2 (SP2), поэтому при установки первого продукта устанавливается и второй указанный продукт. Поэтому пользователи, у которых установлена среда .NET Framework 3.0 с пакетом обновления 2 (SP2), должны установить обновления системы безопасности для .NET Framework 2.0 с пакетом обновления 2 (SP2). Дополнительные сведения см. в [Статье базы знаний Майкрософт 2695500](http://go.microsoft.com/fwlink/?linkid=247462).

**У меня установлена среда .NET Framework 3.5 с пакетом обновления 1 (SP1). Нужно ли мне устанавливать какие-либо обновления?**
В этом бюллетене описана уязвимость слоев объектов .NET Framework 2.0. В установщике .NET Framework 3.5 с пакетом обновления 1 (SP1) запрограммирована установка .NET Framework 2.0 с пакетом обновления 2 (SP2) и .NET Framework 3.0 с пакетом обновления 2 (SP2). Поэтому пользователи, у которых установлена среда .NET Framework 3.5 с пакетом обновления 1 (SP1), должны установить обновления системы безопасности для .NET Framework 2.0 с пакетом обновления 2 (SP2). Дополнительные сведения см. в [Статье базы знаний Майкрософт 2695500](http://go.microsoft.com/fwlink/?linkid=247462).
...
<th style="border:1px solid black;" >
Уязвимость проверки параметров .NET Framework (CVE-2012-0163)
</th>
<th style="border:1px solid black;" >
Общий уровень серьезности
</th>
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4 в случае установки в Windows Server 2008 R2 для систем на базе процессоров Itanium с пакетом обновления 1<sup>[1]</sup>\*
</td>
<td style="border:1px solid black;">
**Критический**  
Удаленное выполнение кода
...
<span></span>
В способе проверки параметров, который используется Microsoft .NET Framework при передаче данных в функцию, существует уязвимость, делающая возможным удаленное выполнение кода. Воспользовавшись этой уязвимостью, злоумышленник может установить полный контроль над системой. После этого злоумышленник сможет устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными правами. Риск для пользователей, учетные записи которых имеют ограниченные права, меньше, чем для пользователей, работающих с правами администратора.

Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2012-0163](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0163).

#### Смягчающие факторы для уязвимости проверки параметров .NET Framework (CVE-2012-0163)
...
#### Временные решения для уязвимости проверки параметров .NET Framework (CVE-2012-0163)
...
#### Часто задаваемые вопросы об уязвимости проверки параметров .NET Framework (CVE-2012-0163)
...
Данная уязвимость вызвана тем, что в системе .NET Framework неверно проверяются параметры при передаче данных в функцию.
...
Это обновление устраняет уязвимость, исправляя способ, которым .NET Framework проверяет параметры.
...
<td style="border:1px solid black;">См. <a href="http://support.microsoft.com/kb/2671605">Статью 2671605 базы знаний Майкрософт</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;" colspan="2">
Для Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1) в Windows Server 2003 с пакетом обновления 2 (SP2):  
...
<td style="border:1px solid black;" colspan="2">
Для Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2) в Windows Server 2003 с пакетом обновления 2 (SP2):  
...
<td style="border:1px solid black;" colspan="2">
Для Microsoft .NET Framework 4 в Windows Server 2003 с пакетом обновления 2:  
...
<td style="border:1px solid black;" colspan="2">
Для Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1) в системе Windows Server 2003 x64 Edition с пакетом обновления 2 (SP2):  
...
<td style="border:1px solid black;" colspan="2">
Для Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2) в системе Windows Server 2003 x64 Edition с пакетом обновления 2 (SP2):  
...
<td style="border:1px solid black;" colspan="2">
Для Microsoft .NET Framework 4, в Windows Server 2003 x64 Edition с пакетом обновления 2:  
...
<td style="border:1px solid black;" colspan="2">
Для Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1) в Windows Server 2003 с пакетом обновления 2 (SP2) для систем на базе процессоров Itanium:  
NDP1.1sp1-KB2656370-X86.exe /quiet
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;" colspan="2">
Для Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2) в Windows Server 2003 с пакетом обновления 2 (SP2) для систем на базе процессоров Itanium:  
...
<td style="border:1px solid black;" colspan="2">
Для Microsoft .NET Framework 4 в Windows Server 2003 for Itanium-based Systems с пакетом обновления 2 (SP2):  
...
<td style="border:1px solid black;" colspan="2">
Для всех поддерживаемых версий Microsoft .NET Framework используйте средство **Установка и удаление программ** панели управления.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
См. [Статью 2671605 базы знаний Майкрософт](http://support.microsoft.com/kb/2671605)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft .NET Framework 4 в случае установки в ОС Windows 7 для 32-разрядных систем и Windows 7 для 32-разрядных систем с пакетом обновления 1:<br />
NDP40-KB2656368-v2-x86.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   Виталия Торопова за совместную работу с [VeriSign iDefense Labs](http://labs.idefense.com/) и сообщение об уязвимости проверки параметров .NET Framework (CVE-2012-0163)
...
-   Вер. 1.1 (13 апреля 2012 г.): В подраздел "Известные проблемы" раздела "Аннотация" добавлена ссылка на статью 2671605 базы знаний Майкрософт.
-   Вер. 2.0 (12 июня 2012 г.) Бюллетень выпущен повторно, чтобы снова предложить обновление для всех уязвимых программных продуктов. Пользователи, уже успешно установившие исходное обновление от 10 апреля 2012 г., должны установить повторно предлагаемое обновление. Дополнительные сведения см. в разделе "Часто задаваемые вопросы об этом обновлении".
