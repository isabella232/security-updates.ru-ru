---
TOCTitle: 'MS09-021'
Title: 'Бюллетень по безопасности (Майкрософт) MS09-021 - Критическое'
ms:assetid: 'ms09-021'
ms:contentKeyID: 61236517
ms:mtpsurl: 'https://technet.microsoft.com/ru-RU/library/ms09-021(v=Security.10)'
---

Security Bulletin

Бюллетень по безопасности (Майкрософт) MS09-021 - Критическое
=============================================================

Уязвимости в Microsoft Office Excel делают возможным удаленное выполнение кода (969462)
---------------------------------------------------------------------------------------
...
Уровень этого обновления определен как критический для всех поддерживаемых выпусков Microsoft Office Excel 2000. Для всех поддерживаемых выпусков Microsoft Office Excel 2002, Microsoft Office Excel 2003, Microsoft Office Excel 2007, Microsoft Office 2004 для Mac и Microsoft Office 2008 для Mac, а также конвертера форматов файлов Open XML для Mac и всех поддерживаемых версий средства просмотра Microsoft Office Excel и пакета обеспечения совместимости Microsoft Office уровень определен как существенный.

Данное обновление устраняет уязвимости путем изменения способа анализа файлов приложением Excel. Дополнительные сведения об этой уязвимости см. в подразделе "Вопросы и ответы" раздела **Сведения об уязвимости**.

**Рекомендация.** Майкрософт рекомендует пользователям установить обновление немедленно.

**Известные проблемы.** В [статье 969462 базы знаний Майкрософт](http://support.microsoft.com/kb/969462) описаны известные на данный момент проблемы, с которыми можно столкнуться при установке этого обновления для системы безопасности. В этой статье также приводятся решения, рекомендованные для устранения этих проблем.
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 с пакетом обновления 1 (SP1) ](http://www.microsoft.com/downloads/details.aspx?familyid=2bcd565a-6acb-407d-80da-0398526ddf99)\*  
(KB969682)
</td>
<td style="border:1px solid black;">
удаленное выполнение кода
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 с пакетом обновления 2 (SP2)](http://www.microsoft.com/downloads/details.aspx?familyid=2bcd565a-6acb-407d-80da-0398526ddf99)\*  
(KB969682)
</td>
<td style="border:1px solid black;">
удаленное выполнение кода
...
<tr>
<td style="border:1px solid black;">
[Пакет обеспечения совместимости Microsoft Office для форматов файлов Word, Excel и PowerPoint 2007 с пакетом обновления 1 (SP1)](http://www.microsoft.com/downloads/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2)  
(KB969679)
</td>
<td style="border:1px solid black;">
Не применимо
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Пакет обеспечения совместимости Microsoft Office для форматов файлов Word, Excel и PowerPoint 2007 с пакетом обновления 2 (SP2)](http://www.microsoft.com/downloads/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2)  
(KB969679)
</td>
<td style="border:1px solid black;">
Не применимо
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 с пакетом обновления 1 (SP1) (32-разрядные выпуски)](http://www.microsoft.com/downloads/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
Не применимо
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 с пакетом обновления 2 (SP2) (32-разрядные выпуски)](http://www.microsoft.com/downloads/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
Не применимо
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 с пакетом обновления 1 (SP1) (64-разрядные выпуски)](http://www.microsoft.com/downloads/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
Не применимо
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 с пакетом обновления 2 (SP2) (64-разрядные выпуски)](http://www.microsoft.com/downloads/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
Не применимо
...
**Кроме того, в бюллетенях MS09-017 и MS09-027 содержатся описания уязвимостей в Microsoft Office 2004 для Mac, Microsoft Office 2008 для Mac и конвертере форматов файлов Open XML для Mac. Как MS09-017 и MS09-027 связаны с данным бюллетенем (MS09-021)?**  
Обновления для системы безопасности для Microsoft Office 2004 для Mac (KB969661), Microsoft Office 2008 для Mac (KB971822) и конвертера форматов файлов Open XML для Mac (KB971824), которые входят в состав этого бюллетеня, также устраняют уязвимости, описанные в [MS09-017](http://go.microsoft.com/fwlink/?linkid=141704) и [MS09-027](http://go.microsoft.com/fwlink/?linkid=147416). Пользователям Microsoft Office 2004 для Mac, Microsoft Office 2008 для Mac или конвертера форматов файлов Open XML Mac необходимо установить эти обновления один раз.
...
<th style="border:1px solid black;" >
Уязвимость, связанная с повреждением указателя записи, — CVE-2009-0549
</th>
<th style="border:1px solid black;" >
Уязвимость, связанная с повреждением записи объекта, — CVE-2009-0557
</th>
<th style="border:1px solid black;" >
Уязвимость, приводящая к повреждению памяти при индексировании массива, — CVE-2009-0558
</th>
<th style="border:1px solid black;" >
Уязвимость, приводящая к переполнению стекового буфера при копировании строки, — CVE-2009-0559
</th>
<th style="border:1px solid black;" >
Уязвимость, приводящая к повреждению памяти при очистке полей, — CVE-2009-0560
</th>
<th style="border:1px solid black;" >
Уязвимость, связанная с переполнением целочисленного значения записи, — CVE-2009-0561
</th>
<th style="border:1px solid black;" >
Уязвимость, связанная с повреждением указателя записи, — CVE-2009-1134
</th>
<th style="border:1px solid black;" >
Общий уровень опасности
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Конвертер файлов Microsoft Office формата Open XML для MAC
</td>
<td style="border:1px solid black;">
**Существенный**  
удаленное выполнение кода
...
<span></span>
В приложении Microsoft Office Excel существует уязвимость, делающая возможным удаленное выполнение кода при открытии пользователем специально созданного файла Excel, содержащего искаженный объект записи. Воспользовавшись этой уязвимостью, злоумышленник может захватить полный контроль над системой, что позволит ему устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.

В перечне "Common Vulnerabilities and Exposures" этой уязвимости присвоен номер [CVE-2009-0549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0549).

#### Факторы, снижающие опасность уязвимости, связанной с повреждением указателя записи, — CVE-2009-0549
...
#### Методы обхода уязвимости, связанной с повреждением указателя записи, — CVE-2009-0549
...
-   Не открывайте и не **сохраняйте** файлы Excel, полученные из ненадежных источников или неожиданно полученные из надежных. Данная уязвимость может быть использована при открытии специально созданного файла.

#### Вопросы и ответы об уязвимости, связанной с повреждением указателя записи, — CVE-2009-0549
...
В перечне "Common Vulnerabilities and Exposures" этой уязвимости присвоен номер [CVE-2009-0557](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0557).

#### Факторы, снижающие опасность уязвимости, связанной с повреждением записи объекта, — CVE-2009-0557
...
#### Методы обхода уязвимости, связанной с повреждением записи объекта, — CVE-2009-0557
...
#### Вопросы и ответы об уязвимости, связанной с повреждением записи объекта, — CVE-2009-0557
...
В перечне "Common Vulnerabilities and Exposures" этой уязвимости присвоен номер [CVE-2009-0558](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0558).

#### Факторы, снижающие опасность уязвимости, приводящей к повреждению памяти при индексировании массива, — CVE-2009-0558
...
#### Методы обхода уязвимости, приводящей к повреждению памяти при индексировании массива, — CVE-2009-0558

К методам обхода уязвимости относятся параметр или изменение конфигурации, которые не приводят к устранению уязвимости, но могут блокировать известные направления атак, прежде чем обновление будет установлено. Корпорация Майкрософт проверила представленные ниже методы обхода проблемы и сообщила, снижают ли они функциональные возможности.

-   Не открывайте и не сохраняйте файлы Excel, полученные из ненадежных источников или неожиданно полученные из надежных. Данная уязвимость может быть использована при открытии специально созданного файла.

#### Вопросы и ответы об уязвимости, приводящей к повреждению памяти при индексировании массива, — CVE-2009-0558
...
В перечне "Common Vulnerabilities and Exposures" этой уязвимости присвоен номер [CVE-2009-0559](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0559).

#### Факторы, снижающие опасность уязвимости, приводящей к переполнению стекового буфера при копировании строки, — CVE-2009-0559
...
#### Методы обхода уязвимости, приводящей к переполнению стекового буфера при копировании строки, — CVE-2009-0559

К методам обхода уязвимости относятся параметр или изменение конфигурации, которые не приводят к устранению уязвимости, но могут блокировать известные направления атак, прежде чем обновление будет установлено. Корпорация Майкрософт проверила представленные ниже методы обхода проблемы и сообщила, снижают ли они функциональные возможности.

-   Не открывайте и не сохраняйте файлы Excel, полученные из ненадежных источников или неожиданно полученные из надежных. Данная уязвимость может быть использована при открытии специально созданного файла.

#### Вопросы и ответы об уязвимости, приводящей к переполнению стекового буфера при копировании строки, — CVE-2009-0559
...
В перечне "Common Vulnerabilities and Exposures" этой уязвимости присвоен номер [CVE-2009-0560](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0560).

#### Факторы, снижающие опасность уязвимости, приводящая к повреждению памяти при очистке полей, — CVE-2009-0560
...
#### Методы обхода уязвимости, приводящая к повреждению памяти при очистке полей, — CVE-2009-0560
...
#### Вопросы и ответы об уязвимости, приводящая к повреждению памяти при очистке полей, — CVE-2009-0560
...
В перечне "Common Vulnerabilities and Exposures" этой уязвимости присвоен номер [CVE-2009-0561](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0561).

#### Факторы, снижающие опасность уязвимости, связанной с переполнением целочисленного значения записи, — CVE-2009-0561
...
#### Методы обхода уязвимости, связанной с переполнением целочисленного значения записи, — CVE-2009-0561
...
#### Вопросы и ответы об уязвимости, связанной с переполнением целочисленного значения записи, —CVE-2009-0561
...
В перечне "Common Vulnerabilities and Exposures" этой уязвимости присвоен номер [CVE-2009-1134](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1134).

#### Факторы, снижающие опасность уязвимости, связанной с повреждением указателя записи, — CVE-2009-1134
...
#### Методы обхода уязвимости, связанной с повреждением указателя записи, — CVE-2009-1134
...
#### Вопросы и ответы об уязвимости, связанной с повреждением указателя записи, — CVE-2009-1134
...
| Microsoft Office Excel 2007 с пакетом обновления 1 (SP1) и Microsoft Office Excel 2007 с пакетом обновления 2 (SP2)                                                                                                                                       | Да.      |
...
| Microsoft Office Excel 2002 с пакетом обновления 3 (SP3)                                                                                                                                                                                                  | Да.     | Да.                         | Да.                                                                     | Да.                                                                     |
| Microsoft Office Excel 2003 с пакетом обновления 3 (SP3)                                                                                                                                                                                                  | Да.     | Да.                         | Да.                                                                     | Да.                                                                     |
| Microsoft Office Excel 2007 с пакетом обновления 1 (SP1) и Microsoft Office Excel 2007 с пакетом обновления 2 (SP2)                                                                                                                                       | Нет.    | Нет.                        | Да.                                                                     | Да.                                                                     |
...
<td style="border:1px solid black;">См. <a href="http://support.microsoft.com/kb/969683">статью 969683 базы знаний Майкрософт</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Сведения о файлах</strong></td>
<td style="border:1px solid black;">См. <a href="http://support.microsoft.com/kb/969680">статью 969680 базы знаний Майкрософт</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Проверка параметров системного реестра</strong></td>
<td style="border:1px solid black;">Не применимо</td>
...
<td style="border:1px solid black;"><strong>Сведения о файлах</strong></td>
<td style="border:1px solid black;">Для Excel 2003<br />
См. <a href="http://support.microsoft.com/kb/969681">статью 969681 базы знаний Майкрософт</a>.<br />
<br />
Для средства просмотра Excel 2003<br />
См. <a href="http://support.microsoft.com/kb/969685">статью 969685 базы знаний Майкрософт</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Проверка параметров системного реестра</strong></td>
<td style="border:1px solid black;">Не применимо</td>
...
<td style="border:1px solid black;"><strong>Сведения о файлах</strong></td>
<td style="border:1px solid black;">Для Excel 2007<br />
См. <a href="http://support.microsoft.com/kb/969682">статью 969682 базы знаний Майкрософт</a>.<br />
<br />
Для средства просмотра Excel:<br />
См. <a href="http://support.microsoft.com/kb/969686">статью 969686 базы знаний Майкрософт</a>.<br />
<br />
Для пакета обеспечения совместимости Microsoft Office для форматов файлов Word, Excel и PowerPoint 2007:<br />
См. <a href="http://support.microsoft.com/kb/969679">статью 969679 базы знаний Майкрософт</a>.<br />
</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Проверка параметров системного реестра</strong></td>
...
-   После завершения установки программу установки можно будет удалить с жесткого диска. Сведения о результатах установки см. в подразделе "Проверка результатов установки обновления". Чтобы удалить установщик, перетащите в корзину том Microsoft Office 2004 для Mac 11.5.5 Update и загруженный файл.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Сведения о файлах</strong></td>
<td style="border:1px solid black;">См. <a href="http://support.microsoft.com/kb/969737">статью 969737 базы знаний Майкрософт</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Проверка параметров системного реестра</strong></td>
<td style="border:1px solid black;">Не применимо</td>
...
-   Бина Лю (Bing Liu) из [отдела FortiGuard Global Security Research компании Fortinet](http://www.fortiguardcenter.com/) за сообщение об уязвимости, связанной с повреждением указателя (CVE-2009-0549);  
-   Бина Лю (Bing Liu) из [отдела FortiGuard Global Security Research компании Fortinet](http://www.fortiguardcenter.com/) за сообщение об уязвимости, связанной с повреждением записи объекта (CVE-2009-0557);  
-   Карстена Эйрама (Carsten H. Eiram) из компании [Secunia](http://secunia.com/) за сообщение об уязвимости, приводящей к повреждению памяти при индексировании массива (CVE-2009-0558);  
-   [группу изучения уязвимостей компании TELUS Security Labs](http://telussecuritylabs.com/) за сообщение об уязвимости, приводящей к переполнению стекового буфера при копировании строки (CVE-2009-0559);  
-   Бина Лю (Bing Liu) из [отдела FortiGuard Global Security Research компании Fortinet](http://www.fortiguardcenter.com/) за сообщение об уязвимости, приводящей к повреждению памяти при очистке полей (CVE-2009-0560);  
-   Шона Ларссона (Sean Larsson) и Джошуа Дрейка (Joshua Drake) из компании [VeriSign iDefense Labs](http://labs.idefense.com/) за сообщение об уязвимости, связанной с переполнением целочисленного значения записи (CVE-2009-0561);  
-   Карстена Х. Эйрама (Carsten H. Eiram) из компании [Secunia](http://secunia.com/) за сообщение об уязвимости, связанной с переполнением целочисленного значения записи (CVE-2009-0561);  
-   компании [TippingPoint](http://www.tippingpoint.com/) и [Zero Day Initiative](http://www.zerodayinitiative.com/) за сообщение об уязвимости, связанной с повреждением указателя записи (CVE-2009-1134).
...
-   Версия 1.1 (17 июня 2009 г.): В подраздел Аннотация раздела "Известные проблемы" добавлена ссылка на статью 969462 базы знаний Майкрософт.
