---
TOCTitle: 'MS13-037'
Title: 'Бюллетень по безопасности (Майкрософт) MS13-037 - Критическое'
ms:assetid: 'ms13-037'
ms:contentKeyID: 61237974
ms:mtpsurl: 'https://technet.microsoft.com/ru-RU/library/ms13-037(v=Security.10)'
---
...
| Статья базы знаний | [2829530](https://support.microsoft.com/kb/2829530) |
|--------------------|-----------------------------------------------------|
...
<td style="border:1px solid black;">
2817183 в [MS13-028](http://go.microsoft.com/fwlink/?linkid=285215)
</td>
</tr>
...
<th style="border:1px solid black;" >
Уязвимость, связанная с использованием Internet Explorer после освобождения (CVE-2013-0811)
</th>
<th style="border:1px solid black;" >
Уязвимость массива JSON, приводящая к раскрытию информации (CVE-2013-1297)
</th>
<th style="border:1px solid black;" >
Уязвимость, связанная с использованием Internet Explorer после освобождения (CVE-2013-1306)
</th>
<th style="border:1px solid black;" >
Уязвимость, связанная с использованием Internet Explorer после освобождения (CVE-2013-1307)
</th>
<th style="border:1px solid black;" >
Уязвимость, связанная с использованием Internet Explorer после освобождения (CVE-2013-1308)
</th>
<th style="border:1px solid black;" >
Уязвимость, связанная с использованием Internet Explorer после освобождения (CVE-2013-1309)
</th>
</tr>
<tr>
<th colspan="7">
...
<th style="border:1px solid black;" >
Уязвимость, связанная с использованием Internet Explorer после освобождения (CVE-2013-1310)
</th>
<th style="border:1px solid black;" >
Уязвимость, связанная с использованием Internet Explorer после освобождения (CVE-2013-1311)
</th>
<th style="border:1px solid black;" >
Уязвимость, связанная с использованием Internet Explorer после освобождения (CVE-2013-1312)
</th>
<th style="border:1px solid black;" >
Уязвимость, связанная с использованием Internet Explorer после освобождения (CVE-2013-2551)
</th>
<th style="border:1px solid black;" >
Уязвимость, связанная с использованием Internet Explorer после освобождения (CVE-2013-3140)
</th>
<th style="border:1px solid black;" >
Общий уровень серьезности
</th>
...
<span></span>
В Internet Explorer существует уязвимость, приводящая к раскрытию информации, которая может позволить злоумышленнику получить доступ к файлам данных JSON и прочитать их содержимое.

В перечне Common Vulnerabilities and Exposures этой уязвимости присвоен номер [CVE-2013-1297](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1297).
...
Это уязвимость, делающая возможным раскрытие информации, существует в контексте текущего пользователя.

**В чем причина уязвимости?**
При определенных процессах Internet Explorer ошибочно разрешает сценарию VBScript считывать файлы данных JSON не из того домена, из которого данный сценарий VBScript был загружен.

**Что такое JSON?**
JSON (нотация объектов JavaScript) — открытый формат обмена данными на основе текста (см. [RFC 4627](http://www.ietf.org/rfc/rfc4627.txt)). Подобно XML он удобочитаем для человека, выполняется независимо и обладает широкой доступностью реализаций. Отформатированные в соответствии со стандартом JSON данные имеют небольшой объем и могут использоваться практически в любой ситуации, когда приложениям необходимо обмениваться структурированной информацией или хранить ее как текст.

**Что может сделать злоумышленник, который воспользуется этой уязвимостью?**
Злоумышленник, успешно воспользовавшийся данной уязвимостью, может читать содержимое файлов данных JSON.

**Каким образом злоумышленник может воспользоваться этой уязвимостью?**
Злоумышленник может создать специальный веб-сайт, предназначенный для использования данной уязвимости через браузер Internet Explorer. Кроме того, он может воспользоваться уязвимостью через веб-сайты, которые уже подверглись атаке, и веб-сайты, которые принимают или размещают сведения или рекламу. Веб-сайты могут включать особым образом созданное содержимое, использующее данную уязвимость. Однако в любом случае злоумышленник не может заставить пользователей просмотреть контролируемое злоумышленником содержимое. Вместо этого злоумышленник должен убедить пользователей выполнить некоторое действие, обычно приглашая их перейти по соответствующей ссылке, ведущей на веб-сайт злоумышленника, в сообщении электронной почты или программы обмена мгновенными сообщениями. Специально созданное веб-содержимое можно также отобразить и передать на уязвимые системы посредством рекламных объявлений или иными способами.
...
Данное обновление устраняет эту уязвимость, изменяя способ авторизации браузером Internet Explorer доступа сценариев к данным.
...
|-----------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| Уязвимость, связанная с использованием Internet Explorer после освобождения | [CVE-2013-0811](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0811) |
| Уязвимость, связанная с использованием Internet Explorer после освобождения | [CVE-2013-1306](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1306) |
| Уязвимость, связанная с использованием Internet Explorer после освобождения | [CVE-2013-1307](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1307) |
| Уязвимость, связанная с использованием Internet Explorer после освобождения | [CVE-2013-1308](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1308) |
| Уязвимость, связанная с использованием Internet Explorer после освобождения | [CVE-2013-1309](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1309) |
| Уязвимость, связанная с использованием Internet Explorer после освобождения | [CVE-2013-1310](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1310) |
| Уязвимость, связанная с использованием Internet Explorer после освобождения | [CVE-2013-1311](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1311) |
| Уязвимость, связанная с использованием Internet Explorer после освобождения | [CVE-2013-1312](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1312) |
| Уязвимость, связанная с использованием Internet Explorer после освобождения | [CVE-2013-2551](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-2551) |
| Уязвимость, связанная с использованием Internet Explorer после освобождения | [CVE-2013-3140](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3140) |
...
|----------------------------------------------------------------------------------|----------------|
| [CVE-2013-0811](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0811) | Нет            |
| [CVE-2013-1306](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1306) | Нет            |
| [CVE-2013-1307](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1307) | Нет            |
| [CVE-2013-1308](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1308) | Нет            |
| [CVE-2013-1309](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1309) | Нет            |
| [CVE-2013-1310](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1310) | Нет            |
| [CVE-2013-1311](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1311) | Нет            |
| [CVE-2013-1312](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1312) | Нет            |
| [CVE-2013-2551](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-2551) | Нет            |
| [CVE-2013-3140](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3140) | Нет            |
...
<td style="border:1px solid black;">Веб-браузер Internet Explorer 6 для всех поддерживаемых выпусков Windows XP:<br />
Используйте средство <strong>Установка и удаление программ</strong> на панели управления или служебную программу Spuninst.exe, которая находится в папке %Windir%\$NTUninstallKB2829530$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Веб-браузер Internet Explorer 7 для всех поддерживаемых выпусков Windows XP:<br />
Используйте средство <strong>Установка и удаление программ</strong> на панели управления или служебную программу Spuninst.exe, которая находится в папке %Windir%\ie7updates\KB2829530-IE7\spuninst.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Веб-браузер Internet Explorer 8 для всех поддерживаемых выпусков Windows XP:<br />
Используйте средство <strong>Установка и удаление программ</strong> на панели управления или служебную программу Spuninst.exe, которая находится в папке %Windir%\ie8updates\KB2829530-IE8\spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Сведения</strong> <strong>о</strong> <strong>файлах</strong></td>
<td style="border:1px solid black;">См. <a href="http://support.microsoft.com/kb/2829530">статью 2829530 базы знаний Майкрософт</a></td>
</tr>
<tr class="even">
...
| **Сведения о файлах**          | См. [статью 2829530 базы знаний Майкрософт](http://support.microsoft.com/kb/2829530)                                                                                                                              |
...
-   Вер. 1.1 (22 мая 2013 г.): В перечне Common Vulnerabilities and Exposures исправлен номер для CVE-2013-3140. Это изменение носит исключительно информационный характер.
