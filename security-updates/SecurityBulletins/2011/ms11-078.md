---
TOCTitle: 'MS11-078'
Title: 'Бюллетень по безопасности (Майкрософт) MS11-078 - Критическое'
ms:assetid: 'ms11-078'
ms:contentKeyID: 61237069
ms:mtpsurl: 'https://technet.microsoft.com/ru-RU/library/ms11-078(v=Security.10)'
---

Security Bulletin

Бюллетень по безопасности (Майкрософт) MS11-078 - Критическое
=============================================================

Уязвимость в .NET Framework и Microsoft Silverlight делает возможным удаленное выполнение кода (2604930)
--------------------------------------------------------------------------------------------------------

Дата публикации: 11 октября 2011 г. | Дата обновления: 10 июля 2012 г.
...
Это обновление для системы безопасности имеет уровень "критический" для Microsoft .NET Framework 1.0 с пакетом обновления 3 (SP3), Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1), Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2), Microsoft .NET Framework 3.5.1 и Microsoft .NET Framework 4 во всех поддерживаемых выпусках системы Microsoft Windows; и Microsoft Silverlight 4. Дополнительные сведения см. в подразделе **Подвержены и не подвержены уязвимости** далее в этом разделе.

Это обновление для системы безопасности устраняет уязвимость, исправляя способ, которым .NET Framework ограничивает наследование в классах. Дополнительные сведения об этой уязвимости см. в подразделе "Часто задаваемые вопросы" для соответствующей уязвимости в следующем ниже разделе **Сведения об уязвимости**.
...
**Известные проблемы.** В [статье 2604930 базы знаний Майкрософт](http://support.microsoft.com/kb/2604930) описаны известные на данный момент проблемы, с которыми пользователи могут столкнуться при установке этого обновления для системы безопасности. В этой статье также приводятся решения, рекомендованные для устранения этих проблем.
...
<td style="border:1px solid black;">
KB953295 в [MS09-061](http://go.microsoft.com/fwlink/?linkid=160527), заменена статьей KB2572066  
KB2416447 в [MS10-070](http://go.microsoft.com/fwlink/?linkid=202409), заменена статьей KB2572067  
KB983583 в [MS10-060](http://go.microsoft.com/fwlink/?linkid=179830), заменена статьей KB2572073  
Нет бюллетеней, замененных статьей KB2572078
</td>
</tr>
...
<td style="border:1px solid black;">
KB953298 в [MS09-061](http://go.microsoft.com/fwlink/?linkid=?????), заменена статьей KB2572069  
KB983583 в [MS10-060](http://go.microsoft.com/fwlink/?linkid=179830), заменена статьей KB2572073  
Нет бюллетеней, замененных статьей KB2572078
</td>
</tr>
...
<td style="border:1px solid black;">
KB2416447 в [MS10-070](http://go.microsoft.com/fwlink/?linkid=202409), заменена статьей KB2572067  
KB983589 в [MS10-060](http://go.microsoft.com/fwlink/?linkid=179830), заменена статьей KB2572075  
Нет бюллетеней, замененных статьей KB2572078
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
Нет бюллетеней, замененных KB2572076  
Нет бюллетеней, замененных статьей KB2572078
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
Нет бюллетеней, замененных KB2572077  
Нет бюллетеней, замененных статьей KB2572078
</td>
</tr>
<tr>
...
Сборка Microsoft Silverlight 4.0.60831, которая является текущей сборкой Microsoft Silverlight на момент первого выпуска этого бюллетеня, устраняет эту уязвимость и не подвержена ей. Сборки Microsoft Silverlight до 4.0.60831 подвержены этой уязвимости.
...
Это обновление для системы безопасности устанавливает версию 4.0.60831. Если у вас установлена эта или более поздняя версия, ваша система не подвержена уязвимости.
...
**Подвержены ли данной уязвимости бета-версия и версия-кандидат (RC) Silverlight 5?**
Нет, все версии Silverlight 5 не подвержены этой уязвимости.
...
В этом бюллетене описана уязвимость слоев объектов .NET Framework 1.1, .NET Framework 2.0 и .NET Framework 4. В установщике .NET Framework 3.0 с пакетом обновления 2 (SP2) запрограммирована установка .NET Framework 2.0 с пакетом обновления 2 (SP2), поэтому при установки первого продукта устанавливается и второй указанный продукт. Поэтому пользователи, у которых установлена среда .NET Framework 3.0 с пакетом обновления 2 (SP2), должны установить обновления безопасности для .NET Framework 2.0 с пакетом обновления 2 (SP2).

**У меня установлена среда .NET Framework 3.5 с пакетом обновления 1 (SP1). Нужно ли мне устанавливать какие-либо обновления?**
В этом бюллетене описана уязвимость слоев объектов .NET Framework 1.1, .NET Framework 2.0 и .NET Framework 4. В установщике .NET Framework 3.5 с пакетом обновления 1 (SP1) запрограммирована установка .NET Framework 2.0 с пакетом обновления 2 (SP2) и .NET Framework 3.0 с пакетом обновления 2 (SP2). Поэтому пользователи, у которых установлена среда .NET Framework 3.5 с пакетом обновления 1 (SP1), должны установить обновления безопасности для .NET Framework 2.0 с пакетом обновления 2 (SP2).
...
<th style="border:1px solid black;" >
Уязвимость наследования классов в .NET Framework (CVE-2011-1253)
</th>
<th style="border:1px solid black;" >
Общий уровень серьезности
</th>
...
<span></span>
В способе, используемом Microsoft .NET Framework и Silverlight для ограничения наследования классов, существует уязвимость, делающая возможным удаленное выполнение кода. Злоумышленник, успешно воспользовавшийся этой уязвимостью, может выполнить произвольный код в контексте безопасности пользователя, выполнившего вход. После этого злоумышленник сможет устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными правами. Риск для пользователей, учетные записи которых имеют ограниченные права, меньше, чем для пользователей, работающих с правами администратора.

Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1253](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1253).

#### Смягчающие факторы для уязвимости наследования классов в .NET Framework (CVE-2011-1253)
...
#### Временные решения для уязвимости наследования классов в .NET Framework (CVE-2011-1253)
...
#### Часто задаваемые вопросы об уязвимости наследования классов в .NET Framework (CVE-2011-1253)
...
Данная уязвимость вызвана тем, что .NET Framework неправильно ограничивает наследование в классах.
...
| Microsoft Silverlight 4 в случае установки в любых выпусках клиентских систем Microsoft Windows                                                              | Да              |
...
| Microsoft Silverlight 4 в случае установки в любых выпусках клиентских систем Microsoft Windows                                                              | Да                         | Да                          |
...
<td style="border:1px solid black;">См. <a href="http://support.microsoft.com/kb/2604930">статью 2604930 базы знаний Майкрософт</a></td>
</tr>
<tr class="odd">
...
**Установка обновления для Microsoft .NET Framework 1.0 с пакетом обновления 3 (SP3) (KB2572066)**
...
**Установка обновления для Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1) (KB2572067)**
...
**Установка обновления для **Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2)** (**KB2572073**)**и** **Microsoft .NET Framework 4******(KB2572078)**
...
**Удаление обновления для Microsoft .NET Framework 1.0 с пакетом обновления 3 (SP3)** **(KB2572066)**
...
**Удаление обновления для Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1) (KB2572067)**
...
**Удаление обновления для Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2) (KB2572073)** **и Microsoft .NET Framework 4.0 (KB2572078)**
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Для Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2) в Windows Server 2003 с пакетом обновления 2 (SP2):<br />
NDP20SP2-KB2572073-x86.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Для Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1) в системе Windows Server 2003 x64 Edition с пакетом обновления 2 (SP2):<br />
NDP1.1sp1-KB2572067-X86.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Для Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2) в системе Windows Server 2003 x64 Edition с пакетом обновления 2 (SP2):<br />
NDP20SP2-KB2572073-x64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Для Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1) в Windows Server 2003 с пакетом обновления 2 (SP2) для систем на базе процессоров Itanium:<br />
NDP1.1sp1-KB2572067-X86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Для Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2) в Windows Server 2003 с пакетом обновления 2 (SP2) для систем на базе процессоров Itanium:<br />
...
**Установка обновления для Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1)** **в** **Windows Server 2003 с пакетом обновления 2 (SP2)** **(KB2572069)**

Обновление для системы безопасности поддерживает следующие параметры установки для Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1) в Windows Server 2003 с пакетом обновления 2 (KB2572069).
...
**Установка обновления для Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1)** **в Windows Server 2003 x64 Edition с пакетом обновления 2 (SP2)** **и** **Windows Server 2003 с пакетом обновления 2 (SP2) для систем на базе процессоров Itanium** **(KB2572067)**
...
**Удаление обновления для** **Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1) в Windows Server 2003 с пакетом обновления 2 (SP2) (KB2572069)**
...
**Удаление обновления** **для** **Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1) в Windows Server 2003 x64 Edition с пакетом обновления 2 (SP2) и Windows Server 2003 с пакетом обновления 2 (SP2) для систем на базе процессоров Itanium (KB2572067)**
...
**Установка обновления для Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP1) (KB2572075)**
...
**Установка обновления для Microsoft .NET Framework 4 (KB2572078)**
...
-   Анонимного исследователя, сотрудничающего в рамках программы [SecuriTeam Secure Disclosure компании Beyond Security](http://www.beyondsecurity.com/ssd.html), за сообщение об уязвимости наследования классов в .NET Framework (CVE-2011-1253)
...
-   Вер. 1.1 (19 октября 2011): Исправлена информация о параметре для установки без перезагрузки для Microsoft .NET Framework 1.1 с пакетом обновления 1 (SP1). Это изменение носит исключительно информационный характер. Оно не вносит изменения в файлы обновления для системы безопасности или процедуру обнаружения.
