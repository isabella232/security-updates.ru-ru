...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2) и Microsoft .NET Framework 3.5 с пакетом обновления 1 (SP1) в ОС Windows Vista x64 Edition с пакетом обновления 1 (SP1) и Windows Vista x64 Edition с пакетом обновления 2 (SP2)
</td>
<td style="border:1px solid black;">
**Критический**  
Удаленное выполнение кода
...
#### Временные решения для уязвимости .NET Framework, приводящей к повреждению стека (CVE-2010-3958)
...
<td style="border:1px solid black;">Для Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2) и Microsoft .NET Framework 3.5 с пакетом обновления 1 (SP1) в ОС Windows XP с пакетом обновления 3 (SP3):<br />
...
<td style="border:1px solid black;">См. <a href="http://support.microsoft.com/kb/2484015">статью 2484015 базы знаний Майкрософт</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">Установка обновления без участия пользователя</td>
<td style="border:1px solid black;">Для Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2) и Microsoft .NET Framework 3.5 с пакетом обновления 1 (SP1), развернутые в Windows Server 2003 с пакетом обновления 2 (SP2):<br />
NDP20SP2-KB2446704-v2-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Для Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2) и Microsoft .NET Framework 3.5 с пакетом обновления 1 (SP1) в Windows Server 2003 x64 Edition с пакетом обновления 2 (SP2):<br />
NDP20SP2-KB2446704-v2-x64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Для Microsoft .NET Framework 2.0 с пакетом обновления 2 (SP2) и Microsoft .NET Framework 3.5 с пакетом обновления 1 (SP1) в ОС Windows Server 2003 for Itanium-based Systems с пакетом обновления 2 (SP2):<br />
...
-   Вер. 2.0 (10 мая 2011): Бюллетень повторно опубликован для повторного предложения обновлений KB2446709 и KB2449742, предназначенных для устранения известной проблемы, касающейся серверов SQL и Exchange с установленным исправлением KB979744.  
-   Вер. 2.1 (14 июня 2011): Дополнен раздел "Часто задаваемые вопросы", в который добавлено объявление об изменении логики обнаружения в замененном бюллетене для Microsoft .NET Framework 3.5.1 в поддерживаемых выпусках Windows 7 и Windows Server 2008 R2. Единственным изменением в этом обновлении является изменение способа обнаружения. В файлы обновления безопасности изменений не вносилось. Пользователям, уже выполнившим успешное обновление компьютеров, не требуется выполнять никаких действий.  
-   Вер. 2.2 (22 июня 2011): Исправлена информация о замещении бюллетеня. Это обновление касается только изменений в бюллетене. Алгоритм обнаружения и файлы обновления безопасности не изменялись.  
-   Вер. 2.3 (26 октября 2011): Исправлена информация о замещении бюллетеня для .NET Framework 4 в 32-разрядных версиях Microsoft Windows. Это обновление касается только изменений в бюллетене. Алгоритм обнаружения и файлы обновления безопасности не изменялись. Также исправлена информация об уязвимости систем, при развертывании которых устанавливалось только ядро сервера, для .NET Framework 4 в ОС Windows Server 2008 R2 для 64-разрядных систем.  
-   Вер. 2.4 (30 ноября 2011): Исправлена информации о замещении бюллетеня для .NET Framework 4 в ОС Windows 7 для 64-разрядных систем с пакетом обновления 1 (SP1), Windows Server 2008 R2 для 64-разрядных систем с пакетом обновления 1 (SP1) и Windows Server 2008 R2 for Itanium-based Systems с пакетом обновления 1 (SP1). Это изменение затрагивает только информацию о замещении бюллетеней. Алгоритм обнаружения и файлы обновления безопасности не изменялись.
