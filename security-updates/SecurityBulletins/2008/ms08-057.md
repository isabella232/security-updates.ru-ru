---
TOCTitle: 'MS08-057'
Title: 'Бюллетень по безопасности (Майкрософт) MS08-057 - Критическое'
ms:assetid: 'ms08-057'
ms:contentKeyID: 61236475
ms:mtpsurl: 'https://technet.microsoft.com/ru-RU/library/ms08-057(v=Security.10)'
---

Security Bulletin

Бюллетень по безопасности (Майкрософт) MS08-057 - Критическое
=============================================================

Уязвимости в приложении Microsoft Excel делают возможным удаленное выполнение кода (956416)
-------------------------------------------------------------------------------------------
...
Это обновление для системы безопасности имеет критический уровень важности для всех поддерживаемых выпусков Microsoft Office Excel 2000 и как существенный — для всех поддерживаемых выпусков Microsoft Office Excel 2002, Microsoft Office Excel 2003, средства просмотра Microsoft Office Excel 2003, Microsoft Office Excel 2007, пакета обеспечения совместимости Microsoft Office, средства просмотра Microsoft Office Excel и сервера Microsoft Office SharePoint Server 2007. Дополнительные сведения см. в подразделе **Подвержены и не подвержены уязвимости** этого раздела.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1b2740e0-ecdd-48ca-84e0-eb187c31eb16">Excel 2000 с пакетом обновления 3 (SP3)</a><br />
(KB955461)</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=27cedef1-c47c-472c-a343-cd9b4ebc2bba">Excel 2002 с пакетом обновления 3 (SP3)</a><br />
(KB955464)</td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4df27e8a-d803-483b-a700-0177d71bf368">Excel 2003 с пакетом обновления 2 (SP2)</a><br />
(KB955466)</td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=124306">MS08-043</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4df27e8a-d803-483b-a700-0177d71bf368">Excel 2003 с пакетом обновления 3 (SP3)</a><br />
(KB955466)</td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=124306">MS08-043</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2765bbc0-ea2e-4b6e-822c-222ee8e5021f">Excel 2007 с пакетом обновления 1 (SP1)</a><br />
(KB955470)</td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=124306">MS08-043</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9769ce08-5207-4c63-b7b9-536266ad6b2b">Cредство просмотра Microsoft Office Excel 2003</a><br />
(KB955468)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9769ce08-5207-4c63-b7b9-536266ad6b2b">Средство просмотра Microsoft Office Excel 2003 с пакетом обновления 3 (SP3)</a><br />
(KB955468)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=83c88444-75b8-44d1-b280-3671394ade45">Средство просмотра Microsoft Office Excel</a><br />
(KB955935)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a7be004-5903-4101-90c5-c0d5f8722af9">Пакет обеспечения совместимости Microsoft Office для форматов файлов Word, Excel и PowerPoint 2007</a><br />
(KB955936)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a7be004-5903-4101-90c5-c0d5f8722af9">Пакет обеспечения совместимости Microsoft Office для форматов файлов Word, Excel и PowerPoint 2007 с пакетом обновления 1 (SP1)</a><br />
(KB955936)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5c29e646-504c-4455-9d35-9a1bed6d7535">Сервер Microsoft Office SharePoint Server 2007</a>*<br />
(KB955937)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5c29e646-504c-4455-9d35-9a1bed6d7535">Microsoft Office SharePoint 2007 с пакетом обновления 1 (SP1)</a>*<br />
(KB955937)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=3c21c405-2c9e-45d0-be4d-8ccd093af31f">Microsoft Office SharePoint Server 2007 x64 Edition с пакетом обновления 1 (SP1)</a>*<br />
(KB955937)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ba4fa21a-7e01-4ef8-9b9f-9d51d00ef094">Microsoft Office 2004 для Mac</a><br />
(KB958312)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e70c5ae0-2858-46de-81f8-dcd1786656b7">Microsoft Office 2008 для Mac</a><br />
(KB958267)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2a8d9a3b-b8a4-43b6-82a6-a2e7d16ae11d">Конвертер форматов файлов Open XML для Mac</a><br />
(KB958304)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">удаленное выполнение кода</td>
<td style="border:1px solid black;">Важно</td>
...
Дополнительные сведения о файлах см. в [статье 956416 базы знаний Майкрософт](http://support.microsoft.com/kb/956416) (на английском языке).
...
**Примечание**. В сервер Microsoft Office SharePoint Server 2007 входят три составляющие: основные компоненты Microsoft Office SharePoint Server, службы Excel и службы InfoPath Forms. Это обновление воздействует на службы Excel.
...
<th style="border:1px solid black;" >Уязвимость, связанная с проверкой объекта календаря, — CVE-2008-3477</th>
<th style="border:1px solid black;" >Уязвимость, связанная с анализом форматов файлов, — CVE-2008-3471</th>
<th style="border:1px solid black;" >Уязвимость, связанная с анализом формул, — CVE-2008-4019</th>
<th style="border:1px solid black;" >Общий уровень опасности</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Excel 2000 с пакетом обновления 3</td>
...
<tr class="even">
<td style="border:1px solid black;">Excel 2002 с пакетом обновления 3 (SP3)</td>
...
<tr class="odd">
<td style="border:1px solid black;">Excel 2003 с пакетом обновления 2 (SP2)</td>
<td style="border:1px solid black;"><strong>Существенный</strong><br />
удаленное выполнение кода</td>
<td style="border:1px solid black;"><strong>Существенный</strong><br />
удаленное выполнение кода</td>
...
<tr class="even">
<td style="border:1px solid black;">Excel 2003 с пакетом обновления 3 (SP3)</td>
<td style="border:1px solid black;"><strong>Существенный</strong><br />
удаленное выполнение кода</td>
<td style="border:1px solid black;"><strong>Существенный</strong><br />
удаленное выполнение кода</td>
...
<tr class="even">
<td style="border:1px solid black;">Excel 2007 с пакетом обновления 1 (SP1)</td>
<td style="border:1px solid black;">Отсутствует</td>
<td style="border:1px solid black;"><strong>Существенный</strong><br />
удаленное выполнение кода</td>
<td style="border:1px solid black;"><strong>Существенный</strong><br />
...
<tr class="even">
<td style="border:1px solid black;">Сервер Microsoft Office SharePoint Server 2007</td>
<td style="border:1px solid black;">Отсутствует</td>
<td style="border:1px solid black;">Отсутствует</td>
<td style="border:1px solid black;"><strong>Существенный</strong><br />
удаленное выполнение кода</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office SharePoint 2007 с пакетом обновления 1 (SP1)</td>
<td style="border:1px solid black;">Отсутствует</td>
<td style="border:1px solid black;">Отсутствует</td>
<td style="border:1px solid black;"><strong>Существенный</strong><br />
удаленное выполнение кода</td>
...
<tr class="even">
<td style="border:1px solid black;">Сервер Microsoft Office SharePoint Server 2007 x64 Edition</td>
<td style="border:1px solid black;">Отсутствует</td>
<td style="border:1px solid black;">Отсутствует</td>
<td style="border:1px solid black;"><strong>Существенный</strong><br />
удаленное выполнение кода</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office SharePoint Server 2007 x64 Edition с пакетом обновления 1 (SP1)</td>
<td style="border:1px solid black;">Отсутствует</td>
<td style="border:1px solid black;">Отсутствует</td>
<td style="border:1px solid black;"><strong>Существенный</strong><br />
удаленное выполнение кода</td>
...
Уязвимость, связанная с проверкой объекта календаря, — CVE-2008-3477  
--------------------------------------------------------------------
  
<span></span>
В способе обработки приложением Excel кэша производительности VBA существует уязвимость, которая делает возможным удаленное выполнение кода, если пользователь открывает с помощью этого кэша специально созданный файл Excel. Воспользовавшись этой уязвимостью, злоумышленник может захватить полный контроль над системой, что позволит ему устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
В перечне Common Vulnerabilities and Exposures этой уязвимости присвоен номер [CVE-2008-3477](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3477).
  
#### Факторы, снижающие опасность уязвимости, связанной с проверкой объекта календаря, — CVE-2008-3477
...
#### Методы обхода уязвимости, связанной с проверкой объекта календаря, — CVE-2008-3477
...
-   Чтобы запретить доступ к группе "Все", измените список управления доступом для библиотеки VBE6.DLL.
  
    **Для Windows 2000 и Windows XP**
  
    Чтобы установить более строгие ограничения в списке управления доступом к библиотеке VBE6.DLL, выполните указанные ниже действия.
    ...
    **Для системы Windows** **Vista** **и Windows Server 2008**
    ...
    **Побочные эффекты:** Встроенные элементы ActiveX не будут работать в документах Office. Пользователи не смогут вставлять объекты в документы.
    ...
    **Для системы Windows** **Vista** **и Windows Server 2008**
    ...
    Введите в командной строке следующую команду с учетной записью администратора:  
    icacls "%ProgramFiles%\\Common Files\\Microsoft Shared\\VBA\\VBA6\\vbe6.dll" /restore %TEMP%\\VBE6\_ACL.TXT
  
#### Вопросы и ответы об уязвимости, связанной с проверкой объекта календаря, — CVE-2008-3477
  
**Какова область воздействия данной уязвимости?**    
Эта уязвимость связана с запуском программного кода в удаленном режиме. Воспользовавшись этой уязвимостью, злоумышленник может захватить полный контроль над системой, Это позволит ему устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
**В чем причина уязвимости?** Приложение Excel не выполняет достаточную проверку данных в кэше производительности VBA.
...
Обновление изменяет способ загрузки приложением Excel кэша производительности VBA с элементами ActiveX.
...
Уязвимость, связанная с анализом форматов файлов, — CVE-2008-3471  
-----------------------------------------------------------------
  
<span></span>
В приложении Microsoft Excel существует уязвимость, связанная с неправильным выделением памяти при загрузке объектов Excel, которая делает возможным удаленное выполнение кода, если пользователь откроет специальным образом созданный файл Excel, содержащий поврежденный объект. Воспользовавшись этой уязвимостью, злоумышленник может захватить полный контроль над системой, что позволит ему устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
В перечне Common Vulnerabilities and Exposures этой уязвимости присвоен номер [CVE-2008-3471](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3471).
  
#### Факторы, снижающие опасность уязвимости, связанной с анализом форматов файлов, — CVE-2008-3471
...
#### Методы обхода уязвимости, связанной с анализом форматов файлов, — CVE-2008-3471
...
#### Вопросы и ответы об уязвимости, связанной с анализом форматов файлов, — CVE-2008-3471
...
**В чем причина уязвимости?** В приложении Microsoft Excel существует уязвимость, позволяющая злоумышленнику удаленно выполнить код при открытии пользователем специально созданной таблицы Excel. Уязвимость связана со способом обработки приложением Microsoft Excel формата файлов таблиц Excel.
  
**Что может сделать злоумышленник, который воспользуется этой уязвимостью?**    
Воспользовавшись ею, злоумышленник может выполнить произвольный код в контексте вошедшего в систему пользователя. Если пользователь вошел в систему с правами администратора, злоумышленник может получить полный контроль над ней. что позволит ему устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями. Риск для пользователей, учетные записи которых имеют ограниченные права, меньше, чем для пользователей, работающих с правами администратора.
  
**Каким образом злоумышленник может воспользоваться этой уязвимостью?**    
Для этого необходимо, чтобы пользователь открыл специально созданную таблицу Excel в уязвимой версии Microsoft Excel.  
При атаке через электронную почту злоумышленник может использовать уязвимость, отправив пользователю файл Excel неправильного формата и убедив его открыть этот файл.  
...
**Как действует обновление?**    
Обновление устраняет уязвимость, изменяя способ, которым приложение Microsoft Excel обрабатывает BIFF-файлы.
...
Уязвимость, связанная с анализом формул, — CVE-2008-4019  
--------------------------------------------------------
  
<span></span>
Уязвимость возникает при анализе документов Microsoft Excel, содержащих специальным образом созданные формулы, встроенные в ячейки. Она может привести к удаленной атаке на систему в контексте вошедшего в нее пользователя.
  
В перечне Common Vulnerabilities and Exposures этой уязвимости присвоен номер [CVE-2008-4019](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4019).
  
#### Факторы, снижающие опасность уязвимости, связанной с анализом формул, — CVE-2008-4019
...
#### Методы обхода уязвимости, связанной с анализом формул, — CVE-2008-4019
  
Корпорацией Майкрософт не найдены методы обхода этой уязвимости.
  
#### Вопросы и ответы об уязвимости, связанной с анализом формул, — CVE-2008-4019
  
**Какова область воздействия данной уязвимости?**    
Эта уязвимость связана с запуском программного кода в удаленном режиме. Воспользовавшись этой уязвимостью, злоумышленник может удаленно установить полный контроль над системой. Это позволит ему устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
**В чем причина уязвимости?** В функции ПОВТОР приложения Excel возможно переполнение целочисленного значения максимальной ширины ячейки, делающее возможным использование уязвимости.
...
**Как действует обновление?**    
Это обновление устраняет целочисленное переполнение, возникающие при загрузке файлов Excel в память.
...
| Сервер Microsoft Office SharePoint Server 2007 x64 Edition                                                                      | Да.      |  
| Microsoft Office SharePoint Server 2007 x64 Edition с пакетом обновления 1 (SP1)                                                | Да.      |
...
| Сервер Microsoft Office SharePoint Server 2007 x64 Edition                                                                      | Нет.    | Нет.                        | Да. См. **примечание для Microsoft Office SharePoint Server 2007** ниже | Да. См. **примечание для Microsoft Office SharePoint Server 2007** ниже |  
| Microsoft Office SharePoint Server 2007 x64 Edition с пакетом обновления 1 (SP1)                                                | Нет.    | Нет.                        | Да. См. **примечание для Microsoft Office SharePoint Server 2007** ниже | Да. См. **примечание для Microsoft Office SharePoint Server 2007** ниже |
...
<td style="border:1px solid black;">См. <a href="http://support.microsoft.com/kb/956416">статью 956416 базы знаний Майкрософт</a> (на английском языке)</td>
</tr>
<tr class="even">
...
Данное обновление для системы безопасности требует наличия на компьютере установщика Windows версии 3.1. Установщик Windows 3.1 и более поздних версий входит в состав всех поддерживаемых версий Windows.
...
#### Office SharePoint Server 2007 (все выпуски)
...
Загрузите и установите нужную языковую версию обновления Microsoft Office 2004 для Mac 11.5.2 с веб-узла [Центра загрузки Майкрософт](http://www.microsoft.com/downloads/details.aspx?familyid=ba4fa21a-7e01-4ef8-9b9f-9d51d00ef094).
...
-   Откройте том обновления Microsoft Office 2004 для Mac 11.5.2 на рабочем столе. Это действие может быть выполнено автоматически.  
-   Чтобы начать установку, в окне тома обновления Microsoft Office 2004 для Mac 11.5.2 дважды щелкните его значок приложения и следуйте инструкциям на экране.  
-   После завершения установки программу установки можно будет удалить с жесткого диска. Сведения о результатах установки см. в подразделе "Проверка результатов установки обновления". Чтобы удалить установщик, перетащите в корзину том обновления Microsoft Office 2004 для Mac 11.5.2 и загруженный файл.
...
Если отображается номер версии **11.5.2**, обновление успешно установлено.
...
Загрузите и установите нужную языковую версию обновления Microsoft Office 2008 для Mac 12.1.3 с веб-узла [Центра загрузки Майкрософт](http://www.microsoft.com/downloads/details.aspx?familyid=e70c5ae0-2858-46de-81f8-dcd1786656b7).
  
-   Завершите работу всех запущенных приложений, включая антивирусные программы, все приложения Microsoft Office, Microsoft Messenger для Mac и уведомления Office, поскольку они могут помешать установке.  
-   Откройте том обновления Microsoft Office 2008 для Mac 12.1.3 на рабочем столе. Это действие может быть выполнено автоматически.  
-   Чтобы начать установку, в окне тома обновления Microsoft Office 2008 для Mac 12.1.3 дважды щелкните его значок приложения и следуйте инструкциям на экране.  
-   После завершения установки программу установки можно будет удалить с жесткого диска. Сведения о результатах установки см. в подразделе "Проверка результатов установки обновления". Чтобы удалить установщик, перетащите в корзину том обновления Microsoft Office 2008 для Mac 12.1.3 и загруженный файл.
...
Если отображается номер версии **12.1.3**, обновление успешно установлено.
...
Загрузите и установите необходимую языковую версию обновления для конвертера формата файлов Open XML для Mac версии 1.0.1 с веб-узла [Центра загрузки Майкрософт](http://www.microsoft.com/downloads/details.aspx?familyid=2a8d9a3b-b8a4-43b6-82a6-a2e7d16ae11d).
  
-   Завершите работу всех запущенных приложений, включая антивирусные программы, все приложения Microsoft Office, Microsoft Messenger для Mac и уведомления Office, поскольку они могут помешать установке.  
-   Откройте том обновления конвертера формата файлов Open XML для Mac версии 1.0.1 на рабочем столе. Это действие может быть выполнено автоматически.  
-   Чтобы начать установку, в окне тома обновления конвертера формата файлов Open XML для Mac версии 1.0.1 дважды щелкните его значок приложения и следуйте инструкциям на экране.  
-   После завершения установки программу установки можно будет удалить с жесткого диска. Сведения о результатах установки см. в подразделе "Проверка результатов установки обновления". Чтобы удалить установщик, перетащите в корзину том обновления конвертера формата файлов Open XML для Mac версии 1.0.1 и загруженный файл.
...
Если отображается номер версии **1.0.1**, обновление успешно установлено.
...
-   Wushi, сотрудничающего с компаниями [TippingPoint](http://www.tippingpoint.com/) и [Zero Day Initiative](http://www.zerodayinitiative.com/), за сообщение об уязвимости, связанной с анализом форматов файлов (CVE-2008-3471);  
-   Лайонела Доненса (Lionel d'Hauenens) из компании [Labo Skopia](http://www.laboskopia.com/), сотрудничающего с [iDefense VCP](http://labs.idefense.com/), за сообщение об уязвимости, связанной с проверкой объекта календаря (CVE-2008-3477);  
-   Джошуа Дрейка (Joshua J. Drake) из компании [iDefense](http://labs.idefense.com/) за сообщение об уязвимости, связанной с проверкой объекта календаря (CVE-2008-3477).
...
-   Версия 1.1 (15 октября 2008 г.). В разделе **Руководство и средства по диагностике и развертыванию** для всех поддерживаемых версий средства просмотра Microsoft Office Excel 2003 изменены на значение "да" сведения, находящиеся в таблице сведений об обнаружении сервера Systems Management Server и сводке развертывания. Это изменение носит исключительно информационный характер. Оно не вносит изменения в двоичные файлы или процедуру обнаружения.  
-   Версия 1.2 (29 октября 2008 г.). Бюллетень обновлен. В раздел **Вопросы и ответы об этом обновлении для системы безопасности** добавлены пояснения к любым дополнительным функциям безопасности, включенным в это обновление для Microsoft Office 2003 с пакетом обновления 2 (SP2). Кроме того, в раздел **Руководство и средства по диагностике и развертыванию** добавлены отсутствующие записи для приложения Excel 2003 с пакетом обновления 3 (SP3). И, наконец, в разделе **Развертывание обновления для системы безопасности** исправлены ссылки на свободно распространяемый установщик Windows. Это изменение носит исключительно информационный характер. Оно не вносит изменения в двоичные файлы.
