---
TOCTitle: 'MS11-054'
Title: 'Бюллетень по безопасности (Майкрософт) MS11-054 - Важное'
ms:assetid: 'ms11-054'
ms:contentKeyID: 61237045
ms:mtpsurl: 'https://technet.microsoft.com/ru-RU/library/ms11-054(v=Security.10)'
---

Security Bulletin

Бюллетень по безопасности (Майкрософт) MS11-054 - Важное
========================================================

Уязвимости драйверов режима ядра Windows делают возможным несанкционированное получение прав (2555917)
------------------------------------------------------------------------------------------------------
...
Это обновление для системы безопасности устраняет уязвимость, исправляя способ, которым драйверы режима ядра осуществляют управление объектами драйверов режима ядра, их отслеживание и проверку параметров функций. Дополнительные сведения об этих уязвимостях см. в подразделе ответов на часто задаваемые вопросы для каждой уязвимости, упомянутой в разделе **Сведения об уязвимостях**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|--------------------------------|-----------------------------------------------------------|
| [Windows XP с пакетом обновления 3 (SP3)](http://www.microsoft.com/downloads/details.aspx?familyid=d7a47370-f415-46ea-9a82-a943f743c8b6)                                                                                                                        | Несанкционированное получение прав  | Существенный                   | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows XP Professional x64 Edition с пакетом обновления 2 (SP2)](http://www.microsoft.com/downloads/details.aspx?familyid=db89d88f-d0d4-4ed6-8589-bf27557c0304)                                                                                               | Несанкционированное получение прав  | Существенный                   | [MS11-041](http://go.microsoft.com/fwlink/?linkid=217499) |
| [Windows Server 2003 с пакетом обновления 2 (SP2)](http://www.microsoft.com/downloads/details.aspx?familyid=7a26a437-a705-4d48-8389-50f159a39891)                                                                                                               | Несанкционированное получение прав  | Существенный                   | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2003 x64 Edition с пакетом обновления 2 (SP2)](http://www.microsoft.com/downloads/details.aspx?familyid=95393f89-0b05-4243-95ed-17bcdad24bfb)                                                                                                   | Несанкционированное получение прав  | Существенный                   | [MS11-041](http://go.microsoft.com/fwlink/?linkid=217499) |
| [Windows Server 2003 с пакетом обновления 2 (SP2) для систем на базе процессоров Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3b094bdb-4150-44f2-a638-afd5f41b00a3)                                                                        | Несанкционированное получение прав  | Существенный                   | [MS11-041](http://go.microsoft.com/fwlink/?linkid=217499) |
| [Windows Vista с пакетом обновления 1 (SP1) и 2 (SP2)](http://www.microsoft.com/downloads/details.aspx?familyid=c1fe1e53-34d5-497e-8ba2-50caa8dc1158)                                                                                                           | Несанкционированное получение прав  | Существенный                   | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Vista x64 Edition с пакетом обновления 1 (SP1) и Windows Vista x64 Edition с пакетом обновления 2 (SP2)](http://www.microsoft.com/downloads/details.aspx?familyid=7bc0a285-cc32-4c6b-abee-d92130d459b7)                                                | Несанкционированное получение прав  | Существенный                   | [MS11-041](http://go.microsoft.com/fwlink/?linkid=217499) |
| [Windows Server 2008 для 32-разрядных систем и Windows Server 2008 для 32-разрядных систем с пакетом обновления 2 (SP2)](http://www.microsoft.com/downloads/details.aspx?familyid=b88d0471-4427-4835-9446-db71116481f0)\*                                       | Несанкционированное получение прав  | Существенный                   | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008 для 64-разрядных (x64) систем и Windows Server 2008 для 64-разрядных (x64) систем с пакетом обновления 2 (SP2)](http://www.microsoft.com/downloads/details.aspx?familyid=d3df6184-3e3c-4949-a1ee-293ec68f8149)\*                           | Несанкционированное получение прав  | Существенный                   | [MS11-041](http://go.microsoft.com/fwlink/?linkid=217499) |
| [Windows Server 2008 for Itanium-based Systems и Windows Server 2008 for Itanium-based Systems с пакетом обновления 2 (SP2)](http://www.microsoft.com/downloads/details.aspx?familyid=9e021d69-7f0c-457f-af86-07e760d8f421)                                     | Несанкционированное получение прав  | Существенный                   | [MS11-041](http://go.microsoft.com/fwlink/?linkid=217499) |
| [Windows 7 для 32-разрядных систем и Windows 7 для 32-разрядных систем с пакетом обновления 1 (SP1)](http://www.microsoft.com/downloads/details.aspx?familyid=41db1b2f-f862-43bb-89bc-4b97737e5cb9)                                                             | Несанкционированное получение прав  | Существенный                   | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows 7 для компьютеров на базе x64-процессоров и Windows 7 для компьютеров на базе x64-процессоров с пакетом обновления 1 (SP1)](http://www.microsoft.com/downloads/details.aspx?familyid=211abdc6-40c7-4bfc-8c2d-be72981f311e)                             | Несанкционированное получение прав  | Существенный                   | [MS11-041](http://go.microsoft.com/fwlink/?linkid=217499) |
| [Windows Server 2008 R2 для компьютеров на базе x64-процессоров и Windows Server 2008 R2 для компьютеров на базе x64-процессоров с пакетом обновления 1 (SP1)](http://www.microsoft.com/downloads/details.aspx?familyid=4f54e498-3825-407d-a036-1900a65d34f1)\* | Несанкционированное получение прав  | Существенный                   | [MS11-041](http://go.microsoft.com/fwlink/?linkid=217499) |
| [Windows Server 2008 R2 for Itanium-based Systems и Windows Server 2008 R2 for Itanium-based Systems с пакетом обновления 1 (SP1)](http://www.microsoft.com/downloads/details.aspx?familyid=e7ae39e8-1154-4a13-8598-29d4a6358762)                               | Несанкционированное получение прав  | Существенный                   | [MS11-041](http://go.microsoft.com/fwlink/?linkid=217499) |
...
<th style="border:1px solid black;" >Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1874)</th>
<th style="border:1px solid black;" >Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1875)</th>
<th style="border:1px solid black;" >Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1876)</th>
<th style="border:1px solid black;" >Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1877)</th>
<th style="border:1px solid black;" >Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1878)</th>
<th style="border:1px solid black;" >Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1879)</th>
<th style="border:1px solid black;" >Уязвимость Win32k, связанная с разыменованием пустого указателя (CVE-2011-1880)</th>
<th style="border:1px solid black;" >Уязвимость Win32k, связанная с разыменованием пустого указателя (CVE-2011-1881)</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<tr class="header">
<th style="border:1px solid black;" >Подвержены уязвимости</th>
<th style="border:1px solid black;" >Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1882)</th>
<th style="border:1px solid black;" >Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1883)</th>
<th style="border:1px solid black;" >Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1884)</th>
<th style="border:1px solid black;" >Уязвимость Win32k, связанная с разыменованием пустого указателя (CVE-2011-1885)</th>
<th style="border:1px solid black;" >Уязвимость проверки параметров Win32k, делающая возможным раскрытие информации (CVE-2011-1886)</th>
<th style="border:1px solid black;" >Уязвимость Win32k, связанная с разыменованием пустого указателя (CVE-2011-1887)</th>
<th style="border:1px solid black;" >Уязвимость Win32k, связанная с разыменованием пустого указателя (CVE-2011-1888)</th>
...
Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1874)  
--------------------------------------------------------------------------------
...
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1874](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1874).
  
#### Смягчающие факторы для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1874)
...
#### Временные решения для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1874)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1874)
...
Эта уязвимость вызвана неправильным управлением объектами драйверов режима ядра.
...
Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1875)  
--------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление объектами драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1875](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1875).
  
#### Смягчающие факторы для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1875)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1875)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1875)
...
Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1876)  
--------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление объектами драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1876](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1876).
  
#### Смягчающие факторы для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1876)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1876)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1876)
...
Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1877)  
--------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление объектами драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1877](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1877).
  
#### Смягчающие факторы для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1877)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1877)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1877)
...
Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1878)  
--------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление объектами драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1878](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1878).
  
#### Смягчающие факторы для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1878)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1878)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1878)
...
Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1879)  
--------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление объектами драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1879](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1879).
  
#### Смягчающие факторы для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1879)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1879)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1879)
...
Уязвимость Win32k, связанная с разыменованием пустого указателя (CVE-2011-1880)  
-------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление указателями на объекты драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1880](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1880).
  
#### Смягчающие факторы для уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1880)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1880)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1880)
  
**Какова область воздействия этой уязвимости?**    
Эта уязвимость может приводить к повышению уровня прав. Злоумышленник, успешно воспользовавшийся этой уязвимостью, может выполнить произвольный код в режиме ядра и получить полный контроль над уязвимой системой. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
**В чем причина уязвимости?**    
Эта уязвимость вызвана разыменованием пустого указателя из-за способа отслеживания драйверами режима ядра указателей на определенные объекты драйверов режима ядра.
...
Уязвимость Win32k, связанная с разыменованием пустого указателя (CVE-2011-1881)  
-------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление указателями на объекты драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1881](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1881).
  
#### Смягчающие факторы для уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1881)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1881)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1881)
...
Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1882)  
--------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление объектами драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1882](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1882).
  
#### Смягчающие факторы для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1882)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1882)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1882)
...
Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1883)  
--------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление объектами драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1883](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1883).
  
#### Смягчающие факторы для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1883)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1883)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1883)
...
Уязвимость, связанная с использованием Win32k после освобождения (CVE-2011-1884)  
--------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление объектами драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1884](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1884).
  
#### Смягчающие факторы для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1884)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1884)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1884)
...
Уязвимость Win32k, связанная с разыменованием пустого указателя (CVE-2011-1885)  
-------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление указателями на объекты драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1885](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1885).
  
#### Смягчающие факторы для уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1885)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1885)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1885)
...
Проверка неправильных параметров Win32k допускает уязвимость, приводящую к раскрытию информации (CVE-2011-1886)  
---------------------------------------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows проверяют параметры функций, существует уязвимость, приводящая к раскрытию информации. Злоумышленник, успешно воспользовавшийся этой уязвимостью, может получить доступ к данным из любого участка памяти в режиме ядра, включая доступ к файлу SAM.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1886](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1886).
  
#### Смягчающие факторы для уязвимости проверки неправильных параметров Win32k, приводящей к раскрытию информации (CVE-2011-1886)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости проверки неправильных параметров Win32k, приводящей к раскрытию информации (CVE-2011-1886)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости проверки неправильных параметров Win32k, приводящей к раскрытию информации (CVE-2011-1886)
...
**Что такое файл SAM?**      
Файл базы данных диспетчера учетных записей безопасности (SAM) — это место хранения паролей пользователей в Windows. Пароли хранятся в этой базе данных хешированными. Хеширование — это криптографический процесс создания уникального "отпечатка" на основе части данных. Хеш-функции — это необратимые функции, поэтому, даже если злоумышленник узнал хеш-значение пароля другого пользователя, он не сможет обратить хеш-функцию, чтобы узнать сам пароль.
  
Однако если бы злоумышленник получил доступ к базе данных SAM, он смог бы выполнить атаку взлома пароля в автономном режиме. Злоумышленник мог бы скопировать базу данных SAM на другой компьютер, затем сгенерировать каждый возможный пароль, хешировать его и сравнить результат с хеш-значениями в базе данных. Например, если бы хеш-значение слова "XYZ" соответствовало одному из значений в этой базе данных, злоумышленник знал бы, что соответствующий пользователь использовал пароль "XYZ". Существуют инструменты, которые позволяют осуществлять такие атаки, если получена копия базы данных SAM.
  
**Что может сделать злоумышленник, который воспользуется этой уязвимостью?**    
Злоумышленник может воспользоваться данной уязвимостью, чтобы получить доступ к данным в любом участке памяти в режиме ядра, включая доступ к файлу SAM.
  
**Каким образом злоумышленник может воспользоваться этой уязвимостью?**    
Из-за способа, которым драйверы режима ядра проверяют некоторые переданные им параметры функций, злоумышленник может получить доступ к данным из любого участка памяти в режиме ядра.
  
**Какие системы в первую очередь подвержены риску?**    
В первую очередь риску подвергаются рабочие станции и серверы терминалов. Серверы могут быть подвержены большему риску, если администраторы позволяют пользователям входить в систему на сервере и запускать программы. Однако общепринятой практикой настоятельно рекомендуется не предоставлять пользователям таких полномочий.
  
**Как действует обновление?**    
Настоящее обновление устраняет указанную уязвимость, изменяя способ, которым драйверы режима ядра проверяют параметры функций.
...
Уязвимость Win32k, связанная с разыменованием пустого указателя (CVE-2011-1887)  
-------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление указателями на объекты драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1887](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1887).
  
#### Смягчающие факторы для уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1887)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1887)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1887)
...
Уязвимость Win32k, связанная с разыменованием пустого указателя (CVE-2011-1888)  
-------------------------------------------------------------------------------
  
<span></span>
В способе, которым драйверы режима ядра Windows осуществляют управление указателями на объекты драйверов режима ядра, существует уязвимость, делающая возможным несанкционированное получение прав. Воспользовавшийся ею злоумышленник может запустить произвольный код в режиме ядра. устанавливать программы, просматривать, изменять и уничтожать данные или создавать новые учетные записи с неограниченными полномочиями.
  
Чтобы просмотреть стандартную запись об этой уязвимости в списке "Common Vulnerabilities and Exposures", см. [CVE-2011-1888](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1888).
  
#### Смягчающие факторы для уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1888)
  
К смягчающим факторам относятся параметр, стандартная конфигурация или общие рекомендации, которые при использовании по умолчанию могут снизить опасность использования уязвимости. Следующие смягчающие факторы могут снизить опасность использования уязвимости.
  
-   Чтобы воспользоваться этой уязвимостью, злоумышленник должен обладать действительными учетными данными и возможностью локального входа в систему. Данной уязвимостью не могут воспользоваться удаленные или анонимные пользователи.
  
#### Временные решения для уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1888)
  
Корпорацией Майкрософт не найдено временных решений для устранения этой уязвимости.
  
#### Часто задаваемые вопросы об уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1888)
...
<td style="border:1px solid black;">Используйте компонент <strong>Установка и удаление программ</strong> панели управления или служебную программу Spuninst.exe, которая находится в папке %Windir%\$NTUninstallKB2555917$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Сведения о файлах</strong></td>
<td style="border:1px solid black;">См. <a href="http://support.microsoft.com/kb/2555917">статью 2555917 базы знаний Майкрософт</a></td>
</tr>
<tr class="even">
...
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1874)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1875)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1876)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1877)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1878)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1879)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1880)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1881)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1882)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1883)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости, связанной с использованием Win32k после освобождения (CVE-2011-1884)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1885)  
-   Лиянь Иня (Liang Yin), проф. Сихань Квинга (Sihan Qing) и Вейпинга Вена (Weiping Wen) и Худзень Джоу (Husheng Zhou) из [отдела информационной безопасности Пекинского университета](http://www.ss.pku.edu.cn/en/) за сообщение об уязвимости проверки параметров Win32k, делающей возможным раскрытие информации (CVE-2011-1886)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1887)  
-   Таржея Мандта (Tarjei Mandt) из компании [Norman](http://www.norman.com) за сообщение об уязвимости Win32k, связанной с разыменованием пустого указателя (CVE-2011-1888)
